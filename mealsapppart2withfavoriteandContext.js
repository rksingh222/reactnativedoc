/**
 * Remember mealapp part1 should be added 
 * all the files should be added before
 * to make this context thing working
 */
 ...
 *
 * the code is pasted in mealsapppart1.js please refer that
 */
